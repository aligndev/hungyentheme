...
<main class="wrapper" data-barba="container" data-barba-namespace="sustainability">
    <?php if (have_rows('sustainability_page_hero_slide')) : ?>
        <section class="process">
            ...
            ?>
                <div class="process-section sec-<?php echo $process_slide_number;
                    ...
                    <div class="container">
                        <div class="process-row">
                                ...
                                <div class="process-heading">
                                    ...
                                    <ul class="process-icon">
                                        <?php foreach ($process_icons as $process_icon) : ?>
                                            <li>
                                                <img src="<?php echo $process_icon['url']; ?>" alt="">
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
                                    <a href="<?php echo $process_button_download_url; ?>" download class="process-download btn btn-green col-9 hide-on-mobile">
                            ...
                            <div class="col-3">
                                <div class="rto-box">
                                    <video autoplay playinlines muted loop>
            ...
            <div class="row tabs-tab">
                <ul class="tabs-list">
                    <li class="tabs-item col-4 active" data-tab-target="#<?php the_field('sustainability_tab_id_one') ?>">
                        <span class="h4"><?php the_field('materials_tab_title')?> </span>
                    </li>
                    <li class="tabs-item col-4" data-tab-target="#<?php the_field('sustainability_tab_id_two')?>">
                        <span class="h4"><?php the_field('sustainability_through_efficiency_tab_title')?> </span>
                    </li>
                    <li class="tabs-item col-4" data-tab-target="#<?php the_field('sustainability_tab_id_three') ?>">
                        <span class="h4"><?php the_field('corporate_social_responsibility_tab_title') ?></span>
                    </li>
                </ul>
            </div>
        </div>
        <div class="tabs-content">
            <div class="container">
                ...
                <div class="tabs-content__item efficiency" id="<?php the_field('sustainability_tab_id_two') ?>" data-tab-content>
                    <h1 class="tabs-content__title h1 col-10 mx-auto uppercase">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide tabsMobile-slide">
                        ...
                        <div class="tabsMobile-inner">
                            <div class="container">
                                ...
                                <div class="tabs-content__video">
                                    <video playsinline muted autoplay loop poster="/src/assets/images/video-poster.png">
                                        <source src="" />
                                    </video>
                                </div>
                        ...
                        <?php if (have_rows('corporate_social_responsibility_slider')) : ?>
                            <div class="slider-inner row">
                                <div class="slider-wrapper col-5">
                                    ...
                                    <div class="slider-cta col-7 row">
                                        <div class="reviewSlider-pagination swiper-pagination body"></div>
                                        <div class="swiper-button-next body reviewSlider-button-next"></div>
                                    </div>
                                </div>
                    ...
                    <div class="tabs-content__icon">
                        <div>
                            <img src="<?php the_field('corporate_social_responsibility_slider_image_bottom_left') ?>" alt="" />
                        </div>
                        <div>
                            <?php
                                $images = get_field('corporate_social_responsibility_slider_image_bottom_right');
                                if ($images) : ?>
